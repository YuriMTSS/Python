...
if comeco > termino:
    temporaria = comeco #guarda o valor do começo em uma variável temporária
    comeco = termino #troca os valores
    termino = comeco #resgata o valor da variável temporária

for x in range(comeco, termino + 1):
    print("%d x %d = %d" %(numero,x , numero * x))
