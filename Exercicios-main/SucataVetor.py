...
dele é testar todos os cerca de 200 mouses que se encontram lá, testando e anotando o estado 
...
deverá receber um número indeterminado de entradas, cada uma contendo: um número de identificação do mouse o tipo de defeito:
necessita da esfera;
