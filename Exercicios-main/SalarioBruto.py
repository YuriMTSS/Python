...
SalarioBruto = int(input("Entre com o salário bruto: "))
Prestacao = int(input("Entre com a prestação: "))

if Prestacao > (SalarioBruto * 0.3):
    print("Não é possível conceder o empréstimo!")
else:
    print("Pode ser emprestado!")
